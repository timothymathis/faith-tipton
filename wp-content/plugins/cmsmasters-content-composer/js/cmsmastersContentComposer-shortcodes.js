...
var cmsmastersShortcodes = { 
	...
	cmsmasters_heading : { 
		...
		fields : { 
			...
			// Tablet Width Monitor
			width_monitor : { 
				type : 		'input', 
				title : 	cmsmasters_shortcodes.heading_field_width_monitor, 
				descr : 	"<span>" + cmsmasters_shortcodes.note + ' ' + cmsmasters_shortcodes.heading_field_size_zero_note + "</span>", 
				def : 		'767', 
				required : 	false, 
				width : 	'number', 
				min : 		'320', 
			...
			custom_font_size : { 
				type : 		'input', 
				title : 	cmsmasters_shortcodes.heading_field_custom_font_size, 
				descr : 	"<span>" + cmsmasters_shortcodes.note + ' ' + cmsmasters_shortcodes.heading_field_size_zero_note + "</span>", 
				def : 		'', 
				required : 	false, 
				width : 	'number', 
			...
			custom_line_height : { 
				type : 		'input', 
				title : 	cmsmasters_shortcodes.heading_field_custom_line_height, 
				descr : 	"<span>" + cmsmasters_shortcodes.note + ' ' + cmsmasters_shortcodes.heading_field_size_zero_note + "</span>", 
				def : 		'', 
				required : 	false, 
				width : 	'number', 
