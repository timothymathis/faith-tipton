...
class Cmsmasters_Content_Composer { 
	function __construct() { 
		define('CMSMASTERS_CONTENT_COMPOSER_VERSION', '2.1.5');
	...
	function cmsmasters_composer_enqueue_scripts($hook) {
		...
		/* Start cmsmasters_heading Translations */
			...
			'heading_field_resp_vert_mar_title' =>				__('Set Custom Margin for Small Screens', 'cmsmasters-content-composer'),
			...
			'heading_field_custom_check' => 					__('Set Custom Font Size for Small Screens', 'cmsmasters-content-composer'),
			'heading_field_width_monitor' => 					__('Monitor Width', 'cmsmasters-content-composer'),
			'heading_field_custom_font_size' => 				__('Custom Font Size', 'cmsmasters-content-composer'),
			'heading_field_size_zero_note' => 					__('number, in pixels (default value if empty or 0)', 'cmsmasters-content-composer'),
			'heading_field_custom_line_height' => 				__('Custom Line Height', 'cmsmasters-content-composer'),
		...
		/* Start cmsmasters_featured_block Translations */
			...
			'featured_field_resp_vert_pad_title' =>				__('Set Custom Padding for Small Screens', 'cmsmasters-content-composer'),
			'featured_field_padding_top_laptop_title' =>		__('Top Padding for Laptop', 'cmsmasters-content-composer'),
			...
			'featured_field_padding_bottom_laptop_title' =>		__('Bottom Padding for Laptop', 'cmsmasters-content-composer'),
			...
			'featured_field_padding_top_tablet_title' =>		__('Top Padding for Tablet', 'cmsmasters-content-composer'),
			...
			'featured_field_padding_bottom_tablet_title' =>		__('Bottom Padding for Tablet', 'cmsmasters-content-composer'),
	...
	// CMSMasters Editor Shortcodes	Translations
		...
		/* Start CMSMasters Column Shortcode Translations */
			...
			'column_field_resp_padding_title' =>				__('Set Custom Paddings for Small Screens', 'cmsmasters-content-composer'),
			'column_field_padding_laptop_title' =>				__('Paddings for Laptop', 'cmsmasters-content-composer'),
			...
			'column_field_padding_tablet_title' =>				__('Paddings for Tablet', 'cmsmasters-content-composer'),
		...
		/* Start CMSMasters Row Shortcode Translations */
			...
			'row_field_resp_vert_pad_title' =>					__('Set Custom Padding for Small Screens', 'cmsmasters-content-composer'),
			'row_field_padding_top_laptop_title' =>				__('Top Padding for Laptop', 'cmsmasters-content-composer'),
			...
			'row_field_padding_bottom_laptop_title' =>			__('Bottom Padding for Laptop', 'cmsmasters-content-composer'),
			...
			'row_field_padding_top_tablet_title' =>				__('Top Padding for Tablet', 'cmsmasters-content-composer'),
			...
			'row_field_padding_bottom_tablet_title' =>			__('Bottom Padding for Tablet', 'cmsmasters-content-composer'),
			...
			'row_field_margin_top_laptop_title' =>				__('Top Margin for Laptop', 'cmsmasters-content-composer'),
			...
			'row_field_margin_bottom_laptop_title' =>			__('Bottom Margin for Laptop', 'cmsmasters-content-composer'),
			...
			'row_field_margin_top_tablet_title' =>				__('Top Margin for Tablet', 'cmsmasters-content-composer'),
			...
			'row_field_margin_bottom_tablet_title' =>			__('Bottom Margin for Tablet', 'cmsmasters-content-composer'),
