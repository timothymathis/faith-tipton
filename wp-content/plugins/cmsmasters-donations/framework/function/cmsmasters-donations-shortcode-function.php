				...
				while ($query->have_posts()) : $query->the_post();
					...
					$out .= '<div class="cmsmasters_column ' . $columns_class . '">';
						if (class_exists('Cmsmasters_Content_Composer')) {
							$out .= cmsmasters_composer_ob_load_template('cmsmasters-donations/cmsmasters-framework/theme-style' . CMSMASTERS_DONATIONS_THEME_STYLE . '/postType/donation-standard.php', $this->donations_atts);
						}
					$out .= '</div>';
...
public function cmsmasters_featured_campaign($atts, $content = null) {
	...
	if ($query->have_posts()) :
		...
		'>' . "\n";
			...
			while ($query->have_posts()) : $query->the_post();
				if (class_exists('Cmsmasters_Content_Composer')) {						
					$out .= cmsmasters_composer_ob_load_template('cmsmasters-donations/cmsmasters-framework/theme-style' . CMSMASTERS_DONATIONS_THEME_STYLE . '/postType/campaign-vertical.php', $this->campaign_atts);
				}
			endwhile;
			...
			">";
				...
				while ($query->have_posts()) : $query->the_post();
					...
					$out .= '<div class="cmsmasters_owl_slider_item">';
						if (class_exists('Cmsmasters_Content_Composer')) {
							$out .= cmsmasters_composer_ob_load_template('cmsmasters-donations/cmsmasters-framework/theme-style' . CMSMASTERS_DONATIONS_THEME_STYLE . '/postType/campaign-horizontal.php', $this->campaigns_atts);
						}
					$out .= '</div>';
