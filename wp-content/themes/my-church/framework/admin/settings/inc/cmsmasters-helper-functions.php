...
function my_church_get_admin_page() {
	global $pagenow;
...
function my_church_default_tab() {
	$current_page = my_church_get_admin_page();
...
function my_church_get_the_tab() {
	global $pagenow;
	
	$default_tab = my_church_default_tab();
...
function my_church_settings_page_header() {
