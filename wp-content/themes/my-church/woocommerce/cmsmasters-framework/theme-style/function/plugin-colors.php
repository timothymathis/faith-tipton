...
function my_church_woocommerce_colors($custom_css) {
...
/***************** Start {$title} WooCommerce Color Scheme Rules ******************/
	...
	{$rule}.link_hover_color {
		" . cmsmasters_color_css('border-color', $cmsmasters_option['my-church' . '_' . $scheme . '_hover']) . "
	}
...
add_filter('my_church_theme_colors_secondary_filter', 'my_church_woocommerce_colors');
