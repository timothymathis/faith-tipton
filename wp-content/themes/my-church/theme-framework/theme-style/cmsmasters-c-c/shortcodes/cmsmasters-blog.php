...
$more_text = ($more_text != '') ? $more_text : esc_html__('Load More Posts', 'my-church');


$filter_text = ($filter_text != '') ? $filter_text : esc_html__('Filter', 'my-church');


$filter_cats_text = ($filter_cats_text != '') ? $filter_cats_text : esc_html__('All', 'my-church');
